...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="userlist.jsp">User Requests</a></li>
...
<table class="table">
    ...
    <tbody>
<%  for (UserDetails ud : userlist.getUsers()) {%>
      <tr>
        <td><%= ud.getId() %></td>
        ...
        <td><%= ud.getEmail() %></td>
        <td><%= ud.isStatus() %></td>
        <td><a href="LogServlet?log=updateuser&userid=<%=ud.getId()%>" class="btn btn-info" role="button">deactivate</a></td>
      </tr>
<% }%>
    </tbody>
  </table>
