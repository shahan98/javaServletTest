...
<%  for (OrderDetails od : orderlist.getOrders(user.getId()))  {%>
      ...
      <tr>
        ...
        <td><%= od.getTotal() %></td>
        <td> 
        <a href="#" class="btn btn-info" role="button"><% System.out.println(od.getStatus()); if (od.getStatus()==1) {out.print("Processing");}
